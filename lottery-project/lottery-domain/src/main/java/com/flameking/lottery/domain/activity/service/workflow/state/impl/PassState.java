...
public class PassState implements IActivityState {
    ...
    public void doRefuse(ActivityStateMachine stateMachine) {
        throw new RuntimeException("活动通过不可拒绝");
    ...
    public void doOpen(ActivityStateMachine stateMachine) {
        throw new RuntimeException("活动通过不可开启");

    }

    @Override
    public Constants.ActivityState getName() {
        return Constants.ActivityState.PASS;
    }
}
